...
This repository contains a project developed as an assignment on the **"Complete JavaScript Course"** by **Jonas Schmedtmann**, built using **HTML5, CSS, JavaScript and NodeJs**.
...
![Screenshot](./static/images/mapty1.png?raw=true 'Mapty app')
